...
class ConnectionState(object):
    ...
    :ivar ~tlslite.messagesocket.MessageSocket msg_sock: message level abstraction for TLS Record Socket
    ...
    :ivar key: various computed cryptographic keys, hashes and secrets related
        ...
        :py:class:`~tlslite.handshakehashes.HandshakeHashes` object that has the

...
def main():
    ...
    for group in [25497, # X25519Kyber768Draft00 draft-tls-westerbaan-xyber768d00-02
        ...
        node = node.add_child(ExpectAlert())
        node.next_sibling = ExpectClose()
        conversations["normal groups with {0}".format(GroupName.toStr(group))] = conversation
        ...
        conversations["only {0}".format(GroupName.toStr(group))] = conversation
    ...
    print("Verify that hybrid ML-KEM key exchange groups don't work")
    print("in TLS 1.2\n")

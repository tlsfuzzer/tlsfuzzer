...
class ExpectCertificateVerify(ExpectHandshake):
    ...
    :param tuple(int,int) version: Expected TLS version of the message. If not provided
    will be taken from the state.
    :param tuple(int,int) sig_alg: Expected value of the signature scheme created by the
    server. If not provided it will be compared with signature algorithm

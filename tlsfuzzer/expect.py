...
class ExpectServerHello(ExpectHandshake):
    ...
    def __init__(self, extensions=None, version=None, resume=False,
        ...
        @param typle server_max_protocol: the higher protocol version supported
        by server. Used for testing downgrade signalling of servers.
    ...
    def _check_downgrade_protection(self, srv_hello):
        ...
        """
        # even if we don't know which version server supportes, some values

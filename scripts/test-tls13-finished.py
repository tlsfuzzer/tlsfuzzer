...
def main():
    ...
    for cipher, prf_bytes in scenarios:
        for mbit in range(8*prf_bytes):
            ...
            node.next_sibling = ExpectClose()
            conversations_long["single bit error - cipher %s, bit %d" \
                               % (CipherSuite.ietfNames[cipher],
                                  mbit)] = conversation

    # truncation
    # cipher, start, end
    scenarios = [(CipherSuite.TLS_AES_128_GCM_SHA256, 0,  -1),
                 ...
                 (CipherSuite.TLS_AES_128_GCM_SHA256, 0,  12),
                 ...
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0,  -16),
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0,  -32),
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0,  12),
                 ...
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 16, None),
    ...
    scenarios = [(CipherSuite.TLS_AES_128_GCM_SHA256, 0, 0, 1),
                 ...
                 (CipherSuite.TLS_AES_128_GCM_SHA256, 0, 16, 0),
                 ...
                 (CipherSuite.TLS_AES_128_GCM_SHA256, 0, 6, 6),
                 ...
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0, 0, 16),
                 ...
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0, 16, 0),
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0, 32, 0),
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0, 12, 0),
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0, 1, 1),
                 (CipherSuite.TLS_AES_256_GCM_SHA384, 0, 6, 6)]
    for cipher, pad_byte, pad_left, pad_right in scenarios:
        ...
        node = node.add_child(ExpectAlert(AlertLevel.fatal,
                                          AlertDescription.decode_error))
        node.next_sibling = ExpectClose()
        conversations_long["padding - cipher %s, "
                           "pad_byte %d, "
                           "pad_left %d, "
                           "pad_right %d" \
                           % (CipherSuite.ietfNames[cipher],

...
def main():
    ...
    for sigalg in (SignatureScheme.rsa_pkcs1_sha1,
        ...
        conversations["check {} signature is refused".format(
                      SignatureScheme.toRepr(sigalg))] = conversation
    ...
    print("Test to verify that server properly refuses to accept pkcs1")
    print("signatures with TLS1.3\n")
    print("version: {0}\n".format(version))

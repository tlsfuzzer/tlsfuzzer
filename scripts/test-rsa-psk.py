...
def help_msg():
    ...
    print(" --psk-identity name  Identity used for PSK connections")
    print(" --psk psk      Hex encoding of the PSK used for connection")
...
def main():
    ...
    if ciphers:
        ...
        if dhe:
            ciphers = [CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA]
        else:
            ciphers = [CipherSuite.TLS_RSA_PSK_WITH_AES_128_CBC_SHA]
    ...
    # TODO really, it's optional, but let's ignore that for now

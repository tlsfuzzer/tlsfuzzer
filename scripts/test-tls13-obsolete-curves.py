...
def main():
    ...
    # https://davidwong.fr/tls13/#appendix-B.3.1.4
    obsolete_groups = (list(range(0x0001, 0x0016 + 1)) +
                       list(range(0x001A, 0x001C + 1)) +
                       list(range(0xFF01, 0XFF02 + 1)))
    ...
    print("Check that TLS 1.3 server handshake_fails obsolete curves.")

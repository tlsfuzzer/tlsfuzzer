...
the test as such:
```
test-record-size-limit.py --reply-AD-size 1 'check if server accepts maximum size in TLS 1.2'
```
or as such:
```
test-record-size-limit.py --reply-AD-size 1 'check if server accepts maximum size in TLS 1.3'
```

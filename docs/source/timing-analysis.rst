...
tests, where system under test is fed data of specific classes, but
in such a way that the tests from specific classes
...
----------------------
It is possible to also analyse RSA private key operations (be it signing

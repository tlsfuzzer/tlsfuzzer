...
As cryptographic security depens on proper use of the primitives, tests
...
As parameter this node accepts a dictionary where keys specify names of
...
.. tip::
    ...
    Tlsfuzzer provides a simple function to verify uniquness of parameters in
    such dictionary: :py:func:`~tlsfuzzer.helpers.uniqueness_check`.

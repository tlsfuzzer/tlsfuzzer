    ...
    for i, row in enumerate(reader):
        ...
        try:
            ...
            if res:
                ...
                # ADH, pss, RC4, x448 unsupported
                # OpenSSL requires extensions to be prosent for negotiation
                # compression not supported in tlslite-ng

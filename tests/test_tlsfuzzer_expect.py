...
class TestExpectServerHello(unittest.TestCase):
    ...
    def test_process_with_default_and_tls_1_3_with_1_2_downgrade_sentinel(self):
        # verify that if server sends TLS 1.3 server hello, we check that it
        # does not include downgrade sentinel
        exp = ExpectServerHello()
        ...
        self.assertIn("downgrade protection sentinel but shouldn",
                      str(e.exception))

    def test_process_with_default_and_tls_1_3_with_1_1_downgrade_sentinel(self):
        # verify that if server sends TLS 1.3 server hello, we check that it
        # does not include downgrade sentinel
        exp = ExpectServerHello()
